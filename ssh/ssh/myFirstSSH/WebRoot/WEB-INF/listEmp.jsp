...
<html>
  <head>
    <title>用户列表</title>
    <script type="text/javascript" language="javascript" src="${pageContext.request.contextPath}/js/jquery-1.3.1.js"></script>
  	<script type="text/javascript" language="javascript" src="${pageContext.request.contextPath}/js/my.js"></script>
  </head>
  <body>
    <h1>用户列表</h1>
    <table>
